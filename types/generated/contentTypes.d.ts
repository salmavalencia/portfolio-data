...
export interface ApiSkillsTechSkillsTech extends Schema.CollectionType {
  collectionName: 'skills_teches';
  info: {
    singularName: 'skills-tech';
    pluralName: 'skills-teches';
    displayName: 'Skills Tech';
  };
  options: {
    draftAndPublish: false;
  };
